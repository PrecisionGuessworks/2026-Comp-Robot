...
public class QuixTalonFXS implements QuixMotorControllerWithEncoder, AutoCloseable {
  ...
  //   if (DriverStation.isFMSAttached()){
  //   // new Alert("Tunables are still LIVE and FMS is attatched!!! Please comment them out in src/main/java/frc/quixlib/motorcontrol/QuixTalonFXS.java", AlertType.kError).set(true);
  //   }
  //   if (DriverStation.isFMSAttached()){
