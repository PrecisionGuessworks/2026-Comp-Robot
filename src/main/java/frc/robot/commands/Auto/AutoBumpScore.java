...
public class AutoBumpScore extends Command {
  private final ShooterSubsystem m_shooter;
  private final HopperSubsystem m_hopper;
  private Timer m_timer = new Timer();
  private int loopCount = 0;

  public AutoBumpScore(
  ...
  public void initialize() {
    m_shooter.setHoodAngle(Constants.Shooter.hoodBumpAngleAuto);
    m_shooter.setShooterVelocity(Constants.Shooter.ShooterBumpVelocityAuto);
    m_timer.restart();
    loopCount = 0;
  }
